...
<body>
   ...
   <div class="exp-lists text-center center">
     <ul class="list-group">
        <li class="list-group-item"><a href="Geolocation.aspx">Geolocation</a></li>
         <li class="list-group-item"><a href="GoogleMaps.aspx">Using Google Maps with HTML5</a></li>
          <li class="list-group-item"><a href="Playlist.aspx">HTML Web Storage API(Music Playlist)</a></li>
